...
namespace ef7_example.Migrations
{
    ...
    [Migration("20230415144452_BorradoSuave")]
            ...
            modelBuilder.Entity("ef7_example.Domain.Entities.CinemaOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InitialDate = new DateTime(2023, 4, 15, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 1,
                            CinemaId = 1,
                            Discount = 10m,
                            EndDate = new DateTime(2023, 4, 22, 0, 0, 0, 0, DateTimeKind.Local),
                            InitialDate = new DateTime(2023, 4, 15, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
