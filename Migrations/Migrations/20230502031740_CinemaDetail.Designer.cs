...
namespace Migrations.Migrations
{
    ...
    [Migration("20230502031740_CinemaDetail")]
    partial class CinemaDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CinemaDetail", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");

                    b.Property<string>("EthicalCode")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("Domain.Entities.CinemaOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CinemaId = 4,
                            Discount = 15m,
                            EndDate = new DateTime(2023, 5, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            InitialDate = new DateTime(2023, 5, 1, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 1,
                            CinemaId = 1,
                            Discount = 10m,
                            EndDate = new DateTime(2023, 5, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            InitialDate = new DateTime(2023, 5, 1, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Content = "Hola Felipe, ¿Como te va?",
                            EmittingId = 2,
                            RecipientId = 1
                        },
                        new
            ...
            modelBuilder.Entity("Domain.Entities.CinemaDetail", b =>
                {
                    b.HasOne("Domain.Entities.Cinema", "Cinema")
                        .WithOne("Detail")
                        .HasForeignKey("Domain.Entities.CinemaDetail", "Id")
            ...
            modelBuilder.Entity("Domain.Entities.Message", b =>
                {
                    b.HasOne("Domain.Entities.Person", "Emitting")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("EmittingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Person", "Recipient")
                        .WithMany("SentMessages")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Emitting");
